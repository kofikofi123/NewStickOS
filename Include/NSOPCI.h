...
void kernel_pciWriteConfig8(u8, u8, u8, u8, u8, u8);
void kernel_pciWriteConfig16(u8, u8, u8, u8, u8, u16);
void kernel_pciWriteConfig32(u8, u8, u8, u8, u32);

void kernel_pciDebug(u8, u8, u8);
void kernel_enumeratePCI();

struct kernel_pciDevice* kernel_pciSearchDevice(u16, u16, struct kernel_pciDevice*);
struct kernel_pciDevice* kernel_pciSearchDeviceByClass(u8, u8, struct kernel_pciDevice*);
