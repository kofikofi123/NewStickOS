...
//kernel_mapPage(0x3000, 0x3000);

void kernel_mapPage(u32 physicalAddress, u32 virtualAddress, u8 enableBit){
    u16 directory = ((virtualAddress >> 22) & 0x3FF);
    u16 table = ((virtualAddress >> 12) & 0x3FF);
    //u16 offset = (virtualAddress & 0xFFF);
    physicalAddress = (physicalAddress & ~(0xFFF));
    enableBit = enableBit & 0x01;
    ...
    *c_pd = *c_pd | enableBit;
    *c_pt = (physicalAddress | (*c_pt & 0xFFF)) | enableBit;
}
